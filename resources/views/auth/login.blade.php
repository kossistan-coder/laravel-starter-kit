            ...
            <div >
                <div   class="flex justify-center ">
                    <div class=" text-center mt-64">
                        <p class="font-bold text-2xl">Connecter à votre Compte</p>
                        <p>Entrer votre email ou mot de passe</p>

                        <form class="w-auto mx-auto pt-14" style="margin-top: 20px">
                            ...
                            <div class="flex flex-col gap-y-3">
                                <a href="{{route('overview')}}" type="submit" class="text-white bg-gray-800 w-96 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Me Connecter</a>
